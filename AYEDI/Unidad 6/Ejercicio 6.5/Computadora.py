...
#CONSTRUCTOR
    ...
    def presentarse(self):
        print(f"""Computadora con id {self.id_modelo} 
de la lista {self.listaPerifericos} y con Sistema Operativo {self.SO}""")
...
class ComputadoraNotebook(Computadora):
    ...
    def agregar_perifericos(self, nuevo_periferico):
        print (f"Los periféricos que tiene la Computadora Notebook son {self.listaPerifericos}")
        self.listaPerifericos.append(nuevo_periferico)
